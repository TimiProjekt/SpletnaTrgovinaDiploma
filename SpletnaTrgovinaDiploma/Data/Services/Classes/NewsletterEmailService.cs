...
namespace SpletnaTrgovinaDiploma.Data.Services
{
    public class NewsletterEmailService : EntityBaseRepository<NewsletterEmail>, INewsletterEmailService
    {
        ...
        public IEnumerable<NewsletterEmail> AllEmailAddressesFromMailingList 
            => context.NewsletterMailingList
                .Select(c => c);
        ...
        public async Task<bool> AddToMailingListAsync(string emailAddress)
        {
        ...
        public async Task<bool> RemoveFromMailingListAsync(string emailAddress)
        {
